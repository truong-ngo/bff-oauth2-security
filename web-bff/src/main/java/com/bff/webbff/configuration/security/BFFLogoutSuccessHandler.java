...
/**
 * Modification of {@link OidcClientInitiatedServerLogoutSuccessHandler} for BFF pattern
 * */
public class BFFLogoutSuccessHandler implements ServerLogoutSuccessHandler {

    private final ServerRedirectStrategy redirectStrategy = new BFFOauth2ServerRedirectStrategy(HttpStatus.ACCEPTED);
     ...
     */
    public BFFLogoutSuccessHandler(
